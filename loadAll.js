...
function gotData(data){
	...
	for (i=0;i<data.length;i++){
		if (data[i].gmina == gmina){
					...
					window.localAuthors = data[i].authors;
		}
	}
}
	...
	renderfeedscript.src = "http://4tour.pl/rss/script.js";
	...
	// get font-awesome
	faLibrary = document.createElement("script");
	faLibrary.type = "text/javascript";
	faLibrary.src = "https://use.fontawesome.com/a790a38805.js";

	head.insertBefore(faLibrary, head.firstChild);
